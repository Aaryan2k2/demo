...
SECRET_KEY = 'django-insecure-6s0h@ty5%lnk5zseeulbh5^&prb9s^mmvb7nh54084&v6%(*$@'
...
STATICFILES_DIRS = [BASE_DIR / "static"]  # Additional directories where static files are located (for development)
